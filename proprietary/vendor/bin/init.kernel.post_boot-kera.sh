...
case "$variant" in
	"3_4_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-kera_default_3_4_1.sh
		;;
	"2_3_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-kera_2_3_1.sh
		;;
	"2_4_0")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-kera_2_4_0.sh
		;;
	"3_2_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-kera_3_2_1.sh
		;;
	*)
